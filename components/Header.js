...
function Header() {
  ...
  return (
    <header className='sticky top-0 z50 shadow-md py-5 md:px-10'>

        {/* Top Nav */}
        <div className=' items-center bg-amazon_blue p-1 flex-grow py-2 z-50 grid grid-cols-3'>
            <div className='mt-0 mr-2 flex items-center flex-grow sm:flex-grow-0'>
                <Image src='/eleganza.jpg' alt='' width={150} height={50} style={{objectFit:"cover"}} className='cursor-pointer rounded-md' />
            </div>
            {/* Search: Middle*/}
        ...
        {/* Right */}
        <div className='text-red-50 items-center text-xs font-bold flex space-x-6 mx-6 whitespace-nowrap justify-end '>
